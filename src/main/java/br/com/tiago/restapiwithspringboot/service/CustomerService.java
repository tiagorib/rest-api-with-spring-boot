...
public class CustomerService {
    ...
    public Customer saveCustomer(Customer customer) {
        if (validateCustomer(customer)) {
            ...
            throw new ResponseStatusException(HttpStatus.BAD_REQUEST,"Não foi encontrado os dados dos clientes)!");
        }
    }
    ...
    public Customer updateCustomer(Customer customer) {
        ...
        if (validateCustomer(customer)) {
            ...
            throw new ResponseStatusException(HttpStatus.BAD_REQUEST,
                    "O valor que o cliente deverá pagar " +
                            " devem ser maiores que 0 (zero)!");
        }
    }
    ...
    public Boolean validateCustomer (Customer customer) {
        if (customer.getEmailCustomer() != null &&
                ...
                customer.getDateCreatedCustomer()  != null
        ) {
            return true;
        } else {
            return false;
