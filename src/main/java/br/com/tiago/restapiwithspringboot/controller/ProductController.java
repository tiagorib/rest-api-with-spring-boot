...
public class ProductController {
    ...
    @Operation(summary = "Method for save products in the database")
    ...
    @Operation(summary = "Method for find by id a product in the database")
    ...
    @Operation(summary = "Method for update product in the database")
